...
const HomeFocusSlide = ({ mediaType, mediaCategory }) => {
        ...
        {movies.map((movie, index) => (
          <SwiperSlide key={index}>
            ...
            <Box sx={{
              ...
              {/*Color of Homepage Featured Movie Text*/}
              <Box sx={{
                height: "100%",
                display: "flex",
                alignItems: "center",
                ...
                <Stack spacing={4} direction="column">
                  ...
                  <Stack direction="row" spacing={1} alignItems="center">
                    {/* rating */}
                    <CircleRating value={movie.vote_average} />
                    {/* rating */}
                  ...
                  <Button
                    ...
                    sx={{ width: "max-content", borderRadius: "10px", color: "cyan"}}
                  >
                    watch trailer
                  </Button>
                  {/* buttons */}
