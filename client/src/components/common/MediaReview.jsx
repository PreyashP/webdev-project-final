...
const ReviewItem = ({ review, onRemoved }) => {
  ...
  const handleButtonClick = () => {
    const encodedName = encodeURIComponent(review.user.displayName);
  ...
  return (
    <Box sx={{
      ...
      <Stack direction="row" spacing={2}>
        <div>
          {user && user.displayName !== null && user.displayName === review.user.displayName ? (
        ...
        <Stack spacing={2} flexGrow={1}>
          <Stack spacing={1}>
            ...
            {user && user.displayName !== null && user.displayName === review.user.displayName ? (
                ...
                <Button onClick={handleButtonClick} sx={{ justifyContent: 'flex-start' }}>
                  <Typography variant="h6" fontWeight={700}>
                    {review.user.displayName}
                  </Typography>
                </Button>
          ...
          {/*Render Delete Button if Logged in for that user's reviews*/}
            ...
            <Stack direction="row" spacing={2}>
              ...
              <Stack spacing={2} flexGrow={1}>
                ...
                <LoadingButton
                  variant="contained"
                  size="large"
                  sx={{ width: "max-content", borderRadius: "15px"}}
